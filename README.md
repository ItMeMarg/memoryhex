...
# Wireframes
In the early stages of this project, I found drawing a rough sketch of layout and elements to be the most productive. The wireframes for this project live [here](#).

Before putting code to IDE, I used [Moqups](https://moqups.com/) to create example pages of features on [mobile](#), [tablet](#), and [desktop](#).
...
- [Bootstrap v4.5](https://getbootstrap.com/docs/4.5.2/getting-started/introduction/) - basic formatting and layout
